...
class Review:
    ...
    def year(self, year):
        if isinstance(year, int) and year >= 2000: 
            ...
            raise ValueError("Year must be an integer from the year 2000 onwards")
    ...
    def summary(self, summary):
        if isinstance(summary, str) and len(summary) > 0: 
            ...
            raise ValueError("summary must be str from the year 2000 onwards")
    @property
    ...
    def employee_id(self, employee_id):
        """Setter for employee_id, ensuring it is a positive integer."""
